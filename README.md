...
- `55e7b06` «XPANEL: ребрендинг» — изменён видимый бренд, ссылки на
...
| `branding.supportUrl` | ссылка поддержки в шапке страницы; по умолчанию ведёт на страницу организации XPANEL на GitHub |
...
AGPL-3.0 требует: если вы предоставляете доступ к XPANEL по сети, пользователи
